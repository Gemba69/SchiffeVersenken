...
print("1");
print("<br>");
$spielDb = new SpielDatenbankSchnittstelle(1,0);
print("2");
print("<br>");
...
$spielzugDb->speicherSpielzugInDb(0,1,5,"ANGRIFF");
$spielzugDb->speicherSpielzugInDb(0,2,5,"ANGRIFF");
$spielzugDb->speicherSpielzugInDb(0,3,5,"ANGRIFF");
$spielzugDb->speicherSpielzugInDb(0,4,5,"ANGRIFF");
$spielzugDb->speicherSpielzugInDb(0,0,5,"ANGRIFF");
print("6");
print("<br>");
